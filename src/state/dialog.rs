    ...
    pub fn about(theme_name: String, config_path: String) -> Self {
        Self {
            ...
            lines: vec![
                ...
                String::from("  Workspaces\t4 isolated desktops with independent pane/editor/preview/terminal state"),
                String::from("  Sessions\tRestores active workspace and pane locations on restart"),
                String::from(
