    ...
    pub fn about(theme_name: String, config_path: String) -> Self {
        Self {
            ...
            lines: vec![
                ...
                String::from("  Defaults\tzeta (official dark), neon (vibrant), monochrome (b&w)"),
                String::from("  Other\tfjord, sandbar, oxide, matrix, norton, dracula"),
    ...
    pub fn help() -> Self {
        Self {
            ...
            lines: vec![
                ...
                String::from("  Themes\tmatrix, norton, fjord, sandbar, oxide"),
